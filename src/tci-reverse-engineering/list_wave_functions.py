#!/usr/bin/env python3
"""List functions related to wave data, compression, serialization in the program."""
...
keywords = [
    "Wave", "Wav", "Audio", "Sample", "Compress", "Decompress",
    "Serialize", "Instrument", "CWave", "CEDWave", "Pool"
]
